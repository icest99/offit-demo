        ...
        <div class="absolute w-screen h-screen max-h-screen flex flex-col">
            ...
            <div class="flex flex-col flex-auto">
                ...
                <Link to="Collaborate" class="flex h-1/5 w-4/6 m-auto mb-4 rounded-3xl bg-yellow-1 shadow-dark">
                        <h1 class="font-prompt-l text-4xl text-white m-auto"> Collaborate </h1>
                </Link>

                <Link to="MultiCompetition" class="flex h-1/5 w-4/6 m-auto rounded-3xl bg-orange-1 shadow-dark mb-28">
