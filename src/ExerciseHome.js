    ...
    return (
        <div class="absolute w-screen h-screen max-h-screen flex flex-col">
            ...
            <div class="flex flex-col flex-auto">
                <div class="shadow-md flex h-1/4 w-5/6 bg-red-1 rounded-r-3xl h-20">
                    <h1 class="self-center text-4xl text-white ml-10 my-auto">
                        Choose Your <br/> Mode
                    </h1>
                </div>

                <Link to="Gacha1" class="shadow-md flex h-1/5 w-4/6 m-auto mb-4 rounded-3xl bg-yellow-1 shadow-dark">
                        <h1 class="font-prompt-l text-4xl text-white m-auto"> Game </h1>
                </Link>

                <Link to="#" class="shadow-md flex h-1/5 w-4/6 m-auto rounded-3xl bg-orange-1 shadow-dark mb-28">
