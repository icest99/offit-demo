            ...
            <div class="flex flex-col flex-auto">
                ...
                <div class="flex flex-col w-4/5 border-8 rounded-3xl border-red-1 shadow-lg overflow-hidden m-auto pb-10" style={{backgroundColor:"#FFFAF6"}}>
                    <div class="justify-around flex flex-row items-baseline mb-5 mt-2">
                        <h1 class="text-3xl mt-2" style={{color:"#FF8A83"}}>Create Mission</h1>
                    </div>

                    <div class="px-10">
                        <textarea class="border-2 border-red-1 text-center rounded-xl outline-none form-textarea block w-full text-xl py-2 placeholder-red-1" rows="1" placeholder="Mission Name"></textarea>
                    </div>

                    <div class="px-10 mt-6">
                        <textarea class="border-2 border-red-1 text-center rounded-xl outline-none form-textarea block w-full text-xl py-4 placeholder-red-1"
                        rows="4" placeholder="Detail"></textarea>
                    </div>

                    <Link to="StartTrack" class=" mx-auto mt-5 h-12 w-28 bg-red-1 rounded-2xl text-white text-2xl flex">
                        <p class="mx-auto my-auto">Create</p>
                    </Link>
